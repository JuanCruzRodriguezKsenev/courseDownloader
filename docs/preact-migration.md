...
| 4 | **Lista de clases** (filas + cards de estado) | hijos de `#ui-list` | 🟡 Etapas 0–1 hechas; falta Etapa 2 (contenedor) | `popup/features/listaClases.preact.js` (+ `.test.js`) |
