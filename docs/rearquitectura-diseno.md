...
| 8a — Los módulos hermanos entran por import, no por global | ✅ **Hecha** y **verificada en navegador** (2026-08-04): pasada completa del popup —listado, filtros, faceta, cola, las 6 islas y una descarga—, más el copy de la pausa por sesión caída, que cambió de fuente en el mismo corte. Cayeron **11 globals**: las 4 factories de features, los 4 puentes de islas, `Renderers`, `BunClient` y las 2 publicaciones muertas de los adaptadores Chrome. El bundle del popup pasó de 16 globals a 5. Detalle en §Registro de la Fase 8a. |
